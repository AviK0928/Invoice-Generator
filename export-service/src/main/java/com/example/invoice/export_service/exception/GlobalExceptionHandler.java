...
public class GlobalExceptionHandler {
    ...
    /**
     * The monthly archive is assembled in memory, so the size cap is a real
     * limit rather than advice. Without this handler the guard returns 500,
    ...
    /** e.g. ?month=notadate on the monthly-zip endpoint. */
